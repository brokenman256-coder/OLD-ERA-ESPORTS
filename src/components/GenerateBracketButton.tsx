  ...
  return (
    <div className="clip-corner border border-neutral-800 bg-neutral-900/80 p-5">
      ...
      <button
        onClick={generate}
        disabled={loading}
        className="clip-corner-sm mt-3 bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 px-5 py-2 text-sm font-bold uppercase tracking-wide hover:brightness-110 disabled:opacity-50"
      >
