    ...
    <div className="mt-10">
      ...
      {open && (
        <form
          ...
          className="mt-4 space-y-3 rounded-lg border border-neutral-800 bg-neutral-900 p-5"
        >
                ...
                <div>
                  ...
                  {m.matchCode && (
                    <p className="mt-1 text-sm">
                      Code: <span className="font-mono font-semibold text-cyan-400">{m.matchCode}</span>
                    </p>
                  )}
                </div>
