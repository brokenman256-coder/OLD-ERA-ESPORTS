...
const WEAVE =
  "repeating-linear-gradient(118deg, transparent 0px, transparent 2px, rgba(255,255,255,0.04) 2px, rgba(255,255,255,0.04) 3px, transparent 3px, transparent 46px)";
...
export default function StaticGamingBackground() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-neutral-950">
      ...
      <div className="absolute inset-0 opacity-[0.3]" style={{ backgroundImage: WEAVE }} />
